                ...
                <div className='container flex items-center justify-between'>
                    <a href="#hero" className='text-xl font-bold text-primary flex items-center'>
                        <span className='relative z-10'>
                            <span className='text-glow text-foreground'> Muhammad Dean Fahreza's </span> 
                            Portfolio
                        </span>
                    </a>
                    {/* desktop navbar */}
                    ...
                    <div className='hidden md:flex space-x-8 '>
                        {navItems.map((item, key) => (
                            <a href={item.href} key={key} className={cn('text-foreground/80 hover:text-primary',
                    ...
                    <div className={cn('fixed inset-0 bg-background/95 backdrop-blur-md z-40 flex flex-col',
                        ...
                        <div className='space-y-8 flex flex-col text-xl'>
                            {navItems.map((item, key) => (
                                <a href={item.href} key={key} className={cn('text-foreground/80',
